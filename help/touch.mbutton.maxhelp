        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 973.0, 552.5991719961166, 80.0, 25.0 ],
                    "text": "click here"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1034.0, 620.0, 155.0, 53.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 957.3333333333334, 720.5, 20.0, 20.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 828.0, 719.0, 73.0, 23.0 ],
                    "text": "0"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 919.6666666666666, 672.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 882.0, 631.0, 132.0, 23.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "embedstate": [
                        ...
                        [ "set_flash_time", 100 ],
                        [ "set_modes", "1 0 2" ],
                        [ "set_labels", "Edit/Locked Clamp Hold" ],
                        [ "set_label_mode", 0 ],
                        [ "set_case_mode", 0 ],
                        [ "set_font_style", 0 ],
                        [ "set_font_name", "Arial" ],
                        ...
                        [ "btn_color_on", 1, 0.6880000000000001, 0.21999999999999997, 0.5666666666666667 ],
                        [ "case_mode", 0 ],
                        [ "count", 3 ],
                        [ "direction", 1 ],
                        [ "flash_time", 100 ],
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 882.0, 537.0, 75.206607401371, 56.198343992233276 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 629.0, 517.0, 50.0, 23.0 ],
                    "text": "0"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 502.0, 517.0, 50.0, 37.0 ],
                    "text": "Touch 0"
                }
            },
            {
