...
// Loop-Safe Re-Entrancy Guard, 2 Outlets (Route Stream + Signum), and Theme Bus.
// ============================================================================
...
setoutletassist(0, "Outlet 0: Activity gate / Signum (1 if any on, 0 if all off)");
...
// =============================================================
// 6. OUTPUT ENGINE: TARGETED [ROUTE] STREAM + SIGNUM GATE
// =============================================================
function output_state(changed_index) {
  ...
  try {
    // Outlet 1 (Right): Event message [name/index state] for [route]
    ...
    // Outlet 0 (Left): Activity gate / Signum (1 if any on, 0 if all off)
    var anyActive = 0;
    for (var i = 0; i < count; i++) {
      if (states[i] > 0) {
        anyActive = 1;
